    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Add New Incoming Good</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="#">Home</a></li>
              <li class="breadcrumb-item">Manage Incoming Good</li>
              <li class="breadcrumb-item active">Add New Incoming Good</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
        ...
        <div class="row">
            <div class="col">
              <div class="card">
                ...
                <div class="card-body">
                    <form id="f-add-incominggood" action="<?= site_url('incominggood/add/save'); ?>" method="post">
                ...
                <div class="card-footer">
                    <div class="row">
                        <div class="col text-center">
                            <button type="submit" class="btn btn-success" form="f-add-incominggood">Save</button>
                            <button type="reset" class="btn btn-secondary" form="f-add-incominggood">Reset</button>
                        </div>
                    </div>
                </div>
              </div>
