    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Add New Outgoing Good</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="#">Home</a></li>
              <li class="breadcrumb-item">Manage Outgoing Good</li>
              <li class="breadcrumb-item active">Add New Outgoing Good</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
        ...
        <div class="row">
            <div class="col">
              <div class="card">
                ...
                <div class="card-body">
                    <form id="f-add-outgoinggood" action="<?= site_url('outgoinggood/add/save'); ?>" method="post">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <select name="measurement" id="measurement" class="form-control w-50">
                                    ...
                                    <option value="<?= $measurement->id; ?>"><?= ucwords($measurement->name) . ' ' . "({$measurement->unit})"; ?></option>
                                    <?php } ?>
                                </select>
                            </div>
                        </div>
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <input type="text" class="form-control w-50" id="name" name="name" placeholder="Product Name">
                            </div>
                        </div>
                        <div class="form-group row">
                            <label for="date" class="col-sm-3 col-form-label text-right">Outgoing Date</label>
                            <div class="col-sm-9">
                                <input type="datetime-local" class="form-control w-50" id="date" name="date" placeholder="Date">
                            </div>
                        </div>
                        <div class="form-group row">
                            <label for="qty" class="col-sm-3 col-form-label text-right">Quantity</label>
                            <div class="col-sm-9">
                                <input type="number" class="form-control w-25" id="qty" name="qty" placeholder="Qty">
                            </div>
                        </div>
                    </form>
                </div>
                <div class="card-footer">
                    <div class="row">
                        <div class="col text-center">
                            <button type="submit" class="btn btn-success" form="f-add-outgoinggood">Save</button>
                            <button type="reset" class="btn btn-secondary" form="f-add-outgoinggood">Reset</button>
                        </div>
                    </div>
                </div>
              </div>
