        ...
        <div class="row">
            <div class="col">
              <div class="card">
                ...
                <div class="card-body">
                    <form id="f-add-color" action="<?= site_url('color/add/save'); ?>" method="post">
                ...
                <div class="card-footer">
                    <div class="row">
                        <div class="col text-center">
                            <button type="submit" class="btn btn-success" form="f-add-color">Save</button>
                            <button type="reset" class="btn btn-secondary" form="f-add-color">Reset</button>
                        </div>
                    </div>
                </div>
              </div>
