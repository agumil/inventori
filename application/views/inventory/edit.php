    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Edit Good (<?= $good->name; ?>)</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
              ...
              <div class="card">
                <div class="card-header">
                  <div class="d-flex align-items-center justify-content-between">
                    ...
                    <a href="<?= site_url('inventory'); ?>" class="btn btn-sm btn-primary">Back</a>
                  </div>                  
                </div>
                <div class="card-body">
                    <form id="f-add-good" action="<?= site_url('inventory/') . $good->id . '/save'; ?>" method="post">
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <select name="brand" id="brand" class="form-control w-50">
                                    ...
                                    <option 
                                        value="<?= $brand->id; ?>"
                                        <?= $brand->id == $good->brand_id ? 'selected' : ''; ?>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <select name="color" id="color" class="form-control w-50">
                                    ...
                                    <option 
                                        value="<?= $color->id; ?>"
                                        <?= $color->id == $good->color_id ? 'selected' : ''; ?>
                            ...
                            <div class="col-sm-9">
                                <select name="measurement" id="measurement" class="form-control w-50">
                                    ...
                                    <option 
                                        ...
                                        <?= $measurement->id == $good->measurement_id ? 'selected' : ''; ?>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <input type="text" class="form-control w-50" id="name" name="name" placeholder="Product Name" value="<?= $good->name; ?>">
                            </div>
                        </div>
                        <div class="form-group row">
                            <label for="qty" class="col-sm-3 col-form-label text-right">Quantity</label>
                            <div class="col-sm-9">
                                <input type="number" class="form-control w-25" id="qty" name="qty" placeholder="Qty" value="<?= $good->quantity; ?>">
                            </div>
                        </div>
                    </form>
                </div>
                <div class="card-footer">
                    <div class="row">
                        <div class="col text-center">
                            <button type="submit" class="btn btn-success" form="f-add-good">Save</button>
                            <button type="reset" class="btn btn-secondary" form="f-add-good">Reset</button>
                        </div>
                    </div>
                </div>
              </div>
